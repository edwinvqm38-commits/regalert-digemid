-- /consulta necesita saber si la norma que esta citando fue derogada o
-- modificada (estado_vigencia) para poder avisarlo en vez de presentarla
-- como ley vigente sin mas. Se agrega esa columna al resultado de
-- buscar_paginas_texto; las alertas (digemid_documentos) no tienen ese
-- concepto, asi que devuelven null.
